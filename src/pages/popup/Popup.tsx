      ...
      <footer className="p-4 border-t border-gray-200 text-center">
        <div className="flex flex-col items-center gap-2">
          <div className="flex space-x-4 items-center">
            ...
            <a 
              href="https://linkedin.com/in/ryan25" 
              target="_blank" 
              rel="noopener noreferrer"
            ...
            >
              <img 
                src={Browser.runtime.getURL('favicon.png')} 
                alt="Memoji" 
                className="grayscale h-6 w-6 hover:grayscale-0 transition-all duration-300" 
              />
            </a>
          </div>
